...
appid = "2f6a6aa9"    #填写控制台中获取的 APPID 信息
api_secret = "MGNhZmYxOGUwMzk5OTY3MTc2NjZhMGVl"   #填写控制台中获取的 APISecret 信息
api_key ="255b0cfda6905b488c67776a057c931b"    #填写控制台中获取的 APIKey 信息
imagedata = open("C:\\Users\\23961\\Desktop\\1.png",'rb').read()
...
if __name__ == '__main__':
    # 添加自动询问功能
    print("自动发送问题: 描述图片上的内容")
    question = checklen(getText("user", "描述图片上的内容"))
    answer = ""
    print("答:", end="")
    main(appid, api_key, api_secret, imageunderstanding_url, question)
    getText("assistant", answer)
    print("\n\n自动询问完成，如需继续对话请输入问题，直接回车退出")
    
    # 保留原有的交互功能
    while True:
        Input = input("\n" +"问:")
        if not Input.strip():  # 如果用户直接回车，退出程序
            break
